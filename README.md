...
Status: **0.2.2**, verified end to end with Bazel 7, 8 and 9. Documentation:
...
- Image: `ghcr.io/erneestoc/conveyor:0.2.2` (multi-arch, non-root, migrates on boot).
- Helm: `helm install conveyor oci://ghcr.io/erneestoc/charts/conveyor --version 0.2.2`, see
