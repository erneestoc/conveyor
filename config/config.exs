...
config :conveyor, Conveyor.Ingest,
  ...
  writer_flush_ms: 20,
  # a shard flushes early once this many batches wait; otherwise after writer_flush_ms
...
config :esbuild,
  ...
  conveyor: [
    args:
      ~w(js/app.js js/profile_worker.js js/log_worker.js --bundle --target=es2022 --outdir=../priv/static/assets/js --external:/fonts/* --external:/images/* --alias:@=.),
