...
Remaining: run the e2e workflow on GitHub once the repo has a remote (the workflow has not executed in Actions yet); a screenshot/GIF for the README; Okta/Google real-tenant OIDC check (Keycloak works locally); the open decisions in §8.
